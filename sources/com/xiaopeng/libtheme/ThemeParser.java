    ...
    private static ThemeView resolveThemeView(Context context, ThemeView themeView) {
        if (context != null && themeView != null) {
            try {
                ...
                if (!TextUtils.isEmpty(themeView.xmlValue) && themeView.xmlValue.startsWith(Constant.AT_STRING) && themeView.xmlValue.contains(InternalZipConstants.ZIP_FILE_SEPARATOR)) {
                    String type = themeView.xmlValue.substring(1, themeView.xmlValue.indexOf(InternalZipConstants.ZIP_FILE_SEPARATOR));
                    String name = themeView.xmlValue.substring(themeView.xmlValue.indexOf(InternalZipConstants.ZIP_FILE_SEPARATOR) + 1);
