...
public class BuildInfoUtils {
    ...
    public static String getSystemVersion() {
        ...
        if ("unknown".equals(result) && (index = (version = getFullSystemVersion()).indexOf(Constant.DATA_SEPARATOR_STRING)) > 1 && (end = version.indexOf(Constant.DATA_SEPARATOR_STRING, index + 1)) > index) {
    ...
    public static String getBid() {
        ...
        return (!TextUtils.isEmpty(version) && (index = version.indexOf(Constant.DATA_SEPARATOR_STRING)) > 1) ? version.substring(index - 1, index) : BID_LAN;
    }
