...
class ApiMatcher {
    ...
    private RemoteOperator getRemoteOperator(@NonNull UriStruct uriStruct) {
        ...
        String processTag = uriStruct.processTag;
        String starts = !TextUtils.isEmpty(processTag) ? processTag + "@" + uriStruct.applicationId + Constant.DOT_STRING : uriStruct.applicationId + Constant.DOT_STRING;
        String ends = Constant.DOT_STRING + uriStruct.serviceName;
