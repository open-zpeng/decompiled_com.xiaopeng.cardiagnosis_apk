...
public interface IRadioController extends ILifeCycle {
    ...
    void setAudioBalanceFader(int value1, int value2) throws Exception;

    void setAudioGEQParams(int band, int frequency, int liftCurve, int gain) throws Exception;

    void setExhibitionModeVolume(int percent) throws Exception;

    void setFmVolume(int channel, int volume) throws Exception;

    void setMainAudioMode(int item, int value) throws Exception;

    void setPowerOffTuner() throws Exception;

    void setPowerOnTuner() throws Exception;

    void setRadioBand(int band) throws Exception;

    void setRadioFrequency(int band, int frequency) throws Exception;

    void setRadioSearchDown() throws Exception;

    void setRadioSearchUp() throws Exception;

    void setRadioVolumeAutoFocus(int percent) throws Exception;

    void setRadioVolumePercent(int channel, int vol) throws Exception;

    void setStartFullBandScan() throws Exception;

    void setStopFullBandScan() throws Exception;

    void setXSoundType(int type) throws Exception;
}
