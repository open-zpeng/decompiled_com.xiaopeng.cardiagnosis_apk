...
public interface IVcuController extends ILifeCycle {
    ...
    int getMaxMileage(int socLimit) throws Exception;
    ...
    void setChargingLimit(int limit) throws Exception;

    void setEnergyRecycle(int level) throws Exception;

    void setFullyCharging() throws Exception;

    void startCharge(int chargeSoc) throws Exception;

    void stopACCharge(int chargeSoc) throws Exception;
