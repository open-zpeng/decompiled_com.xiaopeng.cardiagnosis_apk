...
public interface ICiuController extends ILifeCycle {
    ...
    void setCiuCarWash(boolean b) throws Exception;

    void setCiuConfigurationActive(int version) throws Exception;

    void setCiuDelayOff(int value) throws Exception;

    void setCiuDeliveryUploadMode(int mode) throws Exception;

    void setCiuRainSw(int level) throws Exception;

    void setDeleteFaceId(int delete) throws Exception;

    void setDeleteMulti(int uid, int deleteFaceId) throws Exception;

    void setDistractionStatus(int status) throws Exception;

    void setDmsMode(int mode) throws Exception;

    void setDmsStatus(int status) throws Exception;

    void setDmsStatus(int dmsStatus, int faceIdStatus, int fatigueStatus, int distractionStatus) throws Exception;

    void setDvrEnable(boolean enable) throws Exception;

    void setDvrLockMode(int mode) throws Exception;

    void setDvrMode(int mode) throws Exception;

    void setFaceActionRequest(int action) throws Exception;

    void setFaceIdMode(int mode) throws Exception;

    void setFaceIdSw(int value) throws Exception;

    void setFatIgStatus(int status) throws Exception;

    void setFatigueStatus(int status) throws Exception;

    void setFirmFaceCancel(int i) throws Exception;

    void setFormatMode(int mode) throws Exception;

    void setNotifyCiuAutoLightStatus(boolean enable) throws Exception;

    void setRegHint(int hint) throws Exception;

    void setRegisterRequestMulti(int uid, int faceActionRequest, int faceIdMode) throws Exception;

    void setStartRegFlag(int flag) throws Exception;

    void setStartRegFlow(int flow) throws Exception;

    void setUid(int uid) throws Exception;

    void setVideoOutputMode(int mode) throws Exception;

    void setVideoTimeLenMode(int mode) throws Exception;
}
