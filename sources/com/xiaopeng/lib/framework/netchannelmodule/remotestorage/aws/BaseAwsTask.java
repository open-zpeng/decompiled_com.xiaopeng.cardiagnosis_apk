...
public abstract class BaseAwsTask implements Runnable {
    ...
    public BaseAwsTask build() throws StorageException {
        ...
        if (str == null) {
            ...
            this.mRemoteFolder = str.replace("//", InternalZipConstants.ZIP_FILE_SEPARATOR);
            if (this.mRemoteFolder.startsWith(InternalZipConstants.ZIP_FILE_SEPARATOR)) {
            ...
            if (this.mRemoteFolder.startsWith(this.mBucket)) {
                ...
                this.mRemoteObjectKey = this.mBucket + InternalZipConstants.ZIP_FILE_SEPARATOR + this.mRemoteFolder;
            }
        }
    ...
    public String generateObjectKey(String moduleName) {
        ...
        return this.mBucket + InternalZipConstants.ZIP_FILE_SEPARATOR + moduleName + InternalZipConstants.ZIP_FILE_SEPARATOR + BuildInfoUtils.getSystemVersion() + InternalZipConstants.ZIP_FILE_SEPARATOR + DateUtils.formatDate7(timeStamp) + InternalZipConstants.ZIP_FILE_SEPARATOR + SystemPropertyUtil.getVehicleId() + InternalZipConstants.ZIP_FILE_SEPARATOR + timeStamp + ".zip";
    }
