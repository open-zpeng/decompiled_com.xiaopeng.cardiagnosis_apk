...
public class Bucket {
    ...
    public String generateObjectKey(String moduleName) {
        ...
        return this.mRootName + InternalZipConstants.ZIP_FILE_SEPARATOR + moduleName + InternalZipConstants.ZIP_FILE_SEPARATOR + BuildInfoUtils.getSystemVersion() + InternalZipConstants.ZIP_FILE_SEPARATOR + DateUtils.formatDate7(timeStamp) + InternalZipConstants.ZIP_FILE_SEPARATOR + SystemPropertyUtil.getVehicleId() + InternalZipConstants.ZIP_FILE_SEPARATOR + timeStamp + ".zip";
    }
