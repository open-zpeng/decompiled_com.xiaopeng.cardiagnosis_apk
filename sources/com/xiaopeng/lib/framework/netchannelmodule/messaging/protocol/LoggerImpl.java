...
public class LoggerImpl implements Logger {
    ...
    private void logInternal(Level julLevel, String sourceClass, String sourceMethod, String msg, Object[] inserts, Throwable thrown) {
        ...
        String message = julLevel + Constant.SPACE_STRING + sourceClass + Constant.DOT_STRING + sourceMethod + Constant.COLON_STRING + msg + Constant.SPACE_STRING + Arrays.toString(inserts);
