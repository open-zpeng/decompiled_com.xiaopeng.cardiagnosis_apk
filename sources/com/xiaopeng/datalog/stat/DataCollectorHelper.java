...
public class DataCollectorHelper {
    ...
    private String[] generateUploadInfos() {
        ...
        String objectKeyDir = BUCKET_NAME + "/log/" + BuildInfoUtils.getSystemVersion() + InternalZipConstants.ZIP_FILE_SEPARATOR + DateUtils.formatDate7(timeStamp) + InternalZipConstants.ZIP_FILE_SEPARATOR + SystemPropertyUtil.getVehicleId();
